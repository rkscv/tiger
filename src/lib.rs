...
mod tests {
    ...
    fn test_samples() {
        ...
        assert_matches!(test_sample("test13.tig"), Err(Error::Variant(WithSpan { inner: ErrorVariant::UnsupportedOperandType { .. }, .. })));
        assert_matches!(test_sample("test14.tig"), Err(Error::Variant(WithSpan { inner: ErrorVariant::UnsupportedOperandType { .. }, .. })));
        ...
        assert_matches!(test_sample("test21.tig"), Err(Error::Variant(WithSpan { inner: ErrorVariant::UnsupportedOperandType { .. }, .. })));
        ...
        assert_matches!(test_sample("test26.tig"), Err(Error::Variant(WithSpan { inner: ErrorVariant::UnsupportedOperandType { .. }, .. })));
        ...
        assert_matches!(test_sample("test43.tig"), Err(Error::Variant(WithSpan { inner: ErrorVariant::UnsupportedOperandType { .. }, .. })));
